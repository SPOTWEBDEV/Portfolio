          ...
          <div class="row g-4">
            ...
            <div class="col-xl-8">
              <div class="card content-box-card">
                <div class="card-body portfolio-card">
                  <div class="top-info">
                    <div class="text">
                      <h1 class="main-title">Recent Event</h1>
                      <p>Get the latest new happening on <span class="text-primary">SPOTWEB TECH</span> Hub</p>
                    </div>
                  </div>
            ...
            <script type="module">
              ...
              blogNews.forEach(article => {
                const articleHTML = `
                  <div class="col-xl-6 col-lg-4 col-md-6">
                    <div class="article-publications-item">
                      ...
                      <div class="text">
                        <a href="./blog-details.html?blog=${article.id}" class="title">${article.title}</a>
                        <ul class="list-unstyled">
                ...
                `;
                articlesContainer.innerHTML += articleHTML; // Append the generated HTML to the container
              });
