export const expertiseItems = [
  { imgSrc: "assets/img/Expertarea/1.png", alt: "React Js Image", title: "React Js" },
  { imgSrc: "assets/img/Expertarea/2.png", alt: "Bootstrap Image", title: "Bootstrap" },
...
export const awards = [
  ...
  {
    title: "Best Web Application Design",
    year: "2021 - 2022",
    icon: "assets/img/favicon.svg",  // You can change this path to an actual web app icon
    result: "Gold Winner",
    projectLink: "#"
  },
  {
    title: "Most Innovative Website Build",
    year: "2022 - 2023",
    icon: "assets/img/favicon.svg",  // Replace with a suitable website design icon
    result: "Silver Winner",
    projectLink: "#"
  },
  {
    title: "Top Web Development Project",
    year: "2023 - 2024",
    icon: "assets/img/favicon.svg",  // Replace with a relevant web dev icon
